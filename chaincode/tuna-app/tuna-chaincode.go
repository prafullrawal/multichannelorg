...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	tuna := []Tuna{
		Tuna{Vessel: "923F", Status: "Fresh", Timestamp: "2018-10-22 15:02:44", Holder: "Miriam" , DeviceId: "Mydevice" , ParcelStatus:"New"},
	}
	i := 0
	for i < len(tuna) {
		fmt.Println("i is ", i)
...
func (s *SmartContract) addRecord(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var tuna = Tuna{ Vessel: args[1], Status: args[2], Timestamp: args[3], Holder: args[4] , DeviceId: args[5] , ParcelStatus:args[6] }
